    ...
    <div class="card-body-scroll">
      ...
      <div class="section-block">
        ...
        <div class="row g-2">
          <div class="col-6">
            <div class="info-box">
              <span class="info-label">OTA Name</span>
              <input
                type="text"
                class="info-input"
      ...
      <div class="section-block">
        ...
        <div class="row g-2">
          <div class="col-6">
            <div class="info-box">
              <span class="info-label">Gold Membership</span>
              <input
                type="text"
                class="info-input"
          ...
          <div class="col-6">
            <div class="info-box">
              <span class="info-label">VIP Code</span>
              <input
                type="text"
                class="info-input"
          ...
          <div class="col-6">
            <div class="info-box">
              <span class="info-label">Wake up call</span>
              <input type="datetime-local" class="info-input" />
            </div>
          </div>
        </div>
      </div>
